...
# setup
bot_token = os.environ.get("TOKEN", "1867103850:AAFD9LdTgpYLWmbzuSlEWt7w91aunOC3e9U") 
api_hash = os.environ.get("HASH", "d029ff3bc5680a0ac7c448415ccbc442") 
api_id = os.environ.get("ID", "1721373") 
